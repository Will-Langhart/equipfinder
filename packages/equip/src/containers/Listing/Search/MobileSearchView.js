...
const FilterDrawer = ({ history, location }) => {
  ...
  const [features, setfeatures] = useState(searchParams.features || []);
  ...
  const onChangeAmenity = (checkedAmenityValue) => {
    setfeatures(checkedAmenityValue);
  };
      ...
      >
        <FilterElementsWrapper>
          <Accordion allowZeroExpanded={true}>
            ...
            {/* Start features filter element */}
            <AccordionItem>
              <AccordionItemHeading>
                <AccordionItemButton>
                  <Heading as="h4" content="features" />
                  <IoIosArrowDown />
                </AccordionItemButton>
              </AccordionItemHeading>
              <AccordionItemPanel>
            ...
            {/* End of features filter element */}
